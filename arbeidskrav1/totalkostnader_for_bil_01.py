...
Programmet skal beregne og presentere (i konsollen) de årlige totalkostnadene for 
elbil og for bensinbil samt årlig kostnadsdifferanse basert på informasjon gitt i oppgaven.
...
#Beregne kost elbil
AarligKostElbil = AarligKjoerelengde * (DrivstoffbrukElbil + BomavgiftElbil) + TrafikkforsikringsAvgift*365 + ForsikringElbil

#Beregne kost bensinbil
AarligKostBensinbil = AarligKjoerelengde * (DrivstoffbrukBensinbil + BomavgiftBensinbil) + TrafikkforsikringsAvgift*365 + ForsikringBensinbil
...
if(AarligKostElbil < AarligKostBensinbil): BilligsteBil = "Elbil"

print ("Årlige besparelse ved å velge", BilligsteBil, "er kr :", AarligBesparelse)